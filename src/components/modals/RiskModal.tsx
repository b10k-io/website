                            ...
                            >
                                <Dialog.Panel className="font-mono w-full max-w-lg transform overflow-hidden rounded-2xl bg-white p-4 md:p-8 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="mt-4 text-sm text-black/50 flex flex-col gap-4">
                                        <p>below is a non-exhaustive list of potential risks + mitigations</p>
                                        <table className="table-auto">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>project death</td>
                                                    <td>when the lp unlocks token holders will have the choice of voting to add the residual lp to the <span className="text-black font-semibold">[B10K.IO]</span> community governance token and receive the equivalent $ amount</td>
                                                </tr>
                                                <tr>
                                                    <td>rugpull + other</td>
                                                    <td>we aim to be transparent and to build a relationship with the community that is why we keep a history of projects on this website</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
